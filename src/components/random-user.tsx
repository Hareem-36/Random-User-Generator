...
const RandomUser: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-yellow-200 to-yellow-400">
      <center><h1 className="text-3xl font-bold mb-4 bg-slate-50 text-green-600">Random User Generator</h1></center>
      <center><p className="text-muted-foreground mb-6 font-bold text-zinc-800">
